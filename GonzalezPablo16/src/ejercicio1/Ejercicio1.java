...
public class Ejercicio1 {
	...
	public static void main(String[] args) {
		...
		if ( dia.equalsIgnoreCase("Lunes")) {
			System.out.println("El lunes por la mañana toca es Base de datos.");	
		}
		if ( dia.equalsIgnoreCase("Martes")) {
			System.out.println("El martes por la mañana toca es Itinerario Personal para la empleabilidad I.");	
		}
		if ( dia.equalsIgnoreCase("Miercoles")) {
			System.out.println("El miercoles por la mañana toca es Digitalización Aplicada a los Sectores Productivos GS.");	
		}
		if ( dia.equalsIgnoreCase("Jueves")) {
			System.out.println("El jueves por la mañana toca es Base de datos.");	
		}
		if ( dia.equalsIgnoreCase("Viernes")) {
			System.out.println("El viernes por la mañana toca es Sistemas Informáticos.");	
		}
